...
fun bindingPeoplePlanetDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
...
fun bindStarshipsOnFilmDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
    viewModel: FilmDetailViewModel
) {
...
fun bindPeopleOnSpeciesDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
...
fun bindPeopleOnVehicleDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
...
fun bindPeopleOnStarshipDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
...
fun bindFilmsOnStarshipDetails(
    recyclerView: RecyclerView,
    data: List<String>?,
    viewModel: StarshipDetailViewModel
) {
...
fun bindPlanetOnSpeciesDetails(
    recyclerView: RecyclerView,
    data: String?,
    viewModel: SpeciesDetailViewModel
) {
